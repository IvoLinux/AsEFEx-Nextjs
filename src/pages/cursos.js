  ...
  return <>
    ...
    <section id="content-section">
      ...
      <div style={{ margin: '1cm 6cm 1cm 6cm' }}>
        <Link target="_blank" href="http://www.castelobranco.br/"><Image alt="Universidade Castelo Branco" src="/images/castelo_branco.png" style={{ maxWidth: 310, maxHeight: 200, width: 'auto', height: 'auto' }} width={500} height={500} /></Link>
      </div>
